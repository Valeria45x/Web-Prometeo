...
*(Establece la actitud previa, para medir el cambio al final — H3.)*
...
Muestra una lista de ~20 adjetivos (mezcla de positivos y negativos: *clara, confusa, cercana, fría, profesional, alarmista, confiable, vacía, innovadora, genérica, honesta, agobiante…*). Pide elegir 3–5 que describan la web y explicar una. Mide la resonancia de marca (clave en un proyecto tan emocional).
