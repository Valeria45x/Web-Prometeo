...
El sistema visual deriva de AES-256. En web se traduce como una reticula de cuatro columnas, sin gutter, separada mediante bordes visibles de `1px` en `#303030`.
...
- Celda de firma: rojo `#FF3C54`, usada como interrupcion puntual.
