...
const ENTRY_POINT_LABEL_STAGGER_MS = 70;
const ENTRY_POINT_TITLE_BASE_DELAY_MS = 160;
const ENTRY_POINT_TITLE_STAGGER_MS = 70;
const ENTRY_POINT_TITLE_REVEAL_MS = 620;
const ENTRY_POINT_BODY_BASE_DELAY_MS = 280;
const ENTRY_POINT_BODY_STAGGER_MS = 70;
const ENTRY_POINT_BODY_REVEAL_MS = ENTRY_POINT_MOTION.transitionMs;
const ENTRY_POINT_ACTION_BASE_DELAY_MS = 420;
const ENTRY_POINT_ACTION_STAGGER_MS = 70;
...
export default function EntryPointsSection({ light = false }) {
  ...
  const mutedColor = light ? COLORS.textOnLight : COLORS.textMutedDark;
