...
export const REGISTRO_EMPRESAS = [
  {
    ...
    summary:
      "Club de f\u00fatbol que trabaja su comunidad digital, la gesti\u00f3n de socios y la comunicaci\u00f3n con aficionados bajo reglas claras y verificables.",
  },
  {
    id: "bug-brawl",
    name: "Bug Brawl",
    sector: "Juegos de mesa",
    code: "PRO-2026-021",
