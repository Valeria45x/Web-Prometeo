...
function S1_Hero() {
  ...
  return (
    ...
    >
      ...
      >
        {/* GridMeta top row */}
        <div style={{ gridColumn: "1 / -1", borderBottom: bd }}>
          <GridMeta code="PRO-001" />
        </div>
        ...
        {/* RedCell esquina derecha */}
        <div style={{ borderLeft: bd, gridRow: "2" }}>
          <RedCell text="PRO-001" style={{ width: 38 }} />
        </div>
      </section>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div style={{ borderLeft: bd }}>
          <RedCell style={{ width: 38 }} />
        </div>
      </div>
    </section>
  );
...
function S3_Nexo({ light, setLight }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* GridMeta top row */}
        <div style={{ gridColumn: "1 / -1", borderBottom: bd, transition: CT }}>
          <GridMeta code="PRO-003" light={light} />
        </div>

        {/* RedCell esquina izquierda */}
        <div style={{ gridRow: "2 / span 2", borderRight: bd, transition: CT }}>
          <RedCell style={{ width: 38 }} />
        </div>
  ...
  return (
    <section
      ...
      style={{
        ...
        background: bg,
        display: "grid",
        gridTemplateColumns: "1.15fr 0.85fr auto",
        gridTemplateRows: "auto 1fr",
        transition: CT,
      }}
    >
      {/* GridMeta top row */}
      <div style={{ gridColumn: "1 / -1", borderBottom: bd, transition: CT }}>
        <GridMeta code="PRO-004" light={light} />
      </div>
      ...
      {/* RedCell esquina derecha */}
      <div style={{ gridRow: "2", borderLeft: bd, transition: CT }}>
        <RedCell style={{ width: 38 }} />
      </div>
    </section>
  );
  ...
  return (
    <section
      ...
      style={{
        ...
        gridTemplateRows: `auto ${TH}px 1fr`,
        transition: CT,
      }}
    >
      {/* GridMeta top row */}
      <div style={{ gridColumn: "1 / -1", borderBottom: bd, transition: CT }}>
        <GridMeta code="PRO-005" light={light} />
      </div>

      {/* RedCell esquina izquierda */}
      <div style={{ gridRow: "2 / span 2", borderRight: bd, transition: CT }}>
        <RedCell text="PRO-005" style={{ width: 38 }} />
      </div>
